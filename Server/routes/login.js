...
//Esta funcion async me retorna una promesa
async function verify(token) {
  ...
  //La promesa de verify me regresa un objeto de google
  return {
    nombre: payload.name,
    email: payload.email,
    img: payload.picture,
...
app.post("/google", async (req, res) => {
  ...
  //Como el resultado de verify es una promesa , para que se asigne automaticamente
  //yo le asigno el await , y pongo la funcion como async
